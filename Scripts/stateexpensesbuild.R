state_expenses <- function(){
  ...
  for (i in 1:length(frame_list)) {
    ...
    ggplot(data = data.frame(frame_list[i]), aes(x = Year, y = Total_per_cap)) +
    ...
    ggplot(data = data.frame(frame_list[i]), aes(x = Year, y = Total_Health_per_cap)) +
      geom_line(aes(group = State, colour = State)) +
      geom_point(aes(colour = State)) +
      xlab("Financial Year") +
      ylab("$") +
    ...
    ggplot(data = data.frame(frame_list[i]), aes(x = Year, y = Total_Edu_per_cap)) +
      geom_line(aes(group = State, colour = State)) +
      geom_point(aes(colour = State)) +
      xlab("Financial Year") +
      ylab("$") +
    ...
    ggplot(data = data.frame(frame_list[i]), aes(x = Year, y = Total_Social_per_cap)) +
      geom_line(aes(group = State, colour = State)) +
      geom_point(aes(colour = State)) +
      xlab("Financial Year") +
      ylab("$") +
    ...
    ggplot(data = data.frame(frame_list[i]), aes(x = Year, y = Total_Housing_per_cap)) +
      geom_line(aes(group = State, colour = State)) +
      geom_point(aes(colour = State)) +
      xlab("Financial Year") +
      ylab("$") +
    ...
    ggplot(data = data.frame(frame_list[i]), aes(x = Year, y = Total_Rec_per_cap)) +
      geom_line(aes(group = State, colour = State)) +
      geom_point(aes(colour = State)) +
      xlab("Financial Year") +
      ylab("$") +
    ...
    ggplot(data = data.frame(frame_list[i]), aes(x = Year, y = Total_Energy_per_cap)) +
      geom_line(aes(group = State, colour = State)) +
      geom_point(aes(colour = State)) +
      xlab("Financial Year") +
      ylab("$") +
